...
function umiTongji(){
  var umiId = "406f53b1-0151-4f66-b99d-315cb803e3d3"
  var umiToken = ""
  var umiTime = Date.parse(new Date()); //获取当前时间戳
  var umiUrl = "http://umami.xgy.me/api/websites/"+umiId+"/stats?start_at=0000000000&end_at="+umiTime;
  fetch(umiUrl,{
    method: 'GET',
    mode: 'cors',
    cache: 'default',
